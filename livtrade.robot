...
Підготувати клієнт для користувача
  ...
  Run Keyword If   '${ARGUMENTS[0]}' != 'livtrade_viewer'   Login   ${ARGUMENTS[0]}
...
Створити тендер
  ...
  ...      ${ARGUMENTS[1]} ==  tender_data
    ...
    ${value_valueaddedtaxincluded}=          convert_livtrade_string      ${value_valueaddedtaxincluded}
    ...
    ${auctionperiod_startdate}=        livtrade_convertdate   ${auctionperiod_startdate}
    ...
    livtrade.Додати предмети      ${items}
...
Додати предмети
    ...
    \   livtrade.Додати предмет   ${items[${index}]}     ${index}
...
Задати запитання на тендер
  ...
  livtrade.Задати питання  ${username}  ${tender_uaid}  ${question}
...
Отримати інформацію про awards[0].status
    ...
    ${return_value}=   convert_livtrade_string     ${return_value}
    [Return]  ${return_value}
...
Отримати інформацію про tenderPeriod.startDate
  ...
  ${return_value}=   convert_livtrade_date_to_iso_format   ${return_value}
...
Отримати інформацію із документа
  ...
  ${tender}=  livtrade.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
...
Отримати документ
    ...
    livtrade_download_file   ${url}  ${file_name}  ${OUTPUT_DIR}
    [return]  ${file_name}
...
Завантажити фінансову ліцензію
    [Arguments]  ${username}  ${tender_uaid}  ${filepath}
    livtrade.Завантажити документ в ставку  ${username}  ${filepath}  ${tender_uaid}
...
Отримати інформацію із пропозиції
    ...
    ${bid}=   livtrade.Отримати пропозицію  ${field}
